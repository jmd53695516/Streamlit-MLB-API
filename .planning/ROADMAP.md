...
**Plans**: 3 plans
- [x] 05-01-PLAN.md — Chart module skeleton + Wave 0 test scaffolding + ViewModel fixture factory (Wave 1)
- [x] 05-02-PLAN.md — Stadium geometry traces: fair polygon, infield, baselines, mound, bases (Wave 2)
- [x] 05-03-PLAN.md — HR scatter + hover/customdata + app.py wiring + manual smoke (Wave 3)
**UI hint**: yes
